...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*QueueSchedulerArgs)(nil), (*config.QueueSchedulerArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_QueueSchedulerArgs_To_config_QueueSchedulerArgs(a.(*QueueSchedulerArgs), b.(*config.QueueSchedulerArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.QueueSchedulerArgs)(nil), (*QueueSchedulerArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_QueueSchedulerArgs_To_v1beta2_QueueSchedulerArgs(a.(*config.QueueSchedulerArgs), b.(*QueueSchedulerArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta2_QueueSchedulerArgs_To_config_QueueSchedulerArgs(in *QueueSchedulerArgs, out *config.QueueSchedulerArgs, s conversion.Scope) error {
	return nil
}

// Convert_v1beta2_QueueSchedulerArgs_To_config_QueueSchedulerArgs is an autogenerated conversion function.
func Convert_v1beta2_QueueSchedulerArgs_To_config_QueueSchedulerArgs(in *QueueSchedulerArgs, out *config.QueueSchedulerArgs, s conversion.Scope) error {
	return autoConvert_v1beta2_QueueSchedulerArgs_To_config_QueueSchedulerArgs(in, out, s)
}

func autoConvert_config_QueueSchedulerArgs_To_v1beta2_QueueSchedulerArgs(in *config.QueueSchedulerArgs, out *QueueSchedulerArgs, s conversion.Scope) error {
	return nil
}

// Convert_config_QueueSchedulerArgs_To_v1beta2_QueueSchedulerArgs is an autogenerated conversion function.
func Convert_config_QueueSchedulerArgs_To_v1beta2_QueueSchedulerArgs(in *config.QueueSchedulerArgs, out *QueueSchedulerArgs, s conversion.Scope) error {
	return autoConvert_config_QueueSchedulerArgs_To_v1beta2_QueueSchedulerArgs(in, out, s)
}
